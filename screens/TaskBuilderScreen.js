...
export default function TaskBuilderScreen() {
  return (
    <View style={styles.wrap}>
      ...
      <Text style={styles.p}>Aquí generaremos un proceso guiado a partir de lo que tengas en el Panel de control (búsquedas, códigos, fotos). En esta fase es un prototipo visual.</Text>
